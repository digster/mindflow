...
- [schema/mindflow-1.6.1.schema.json](schema/mindflow-1.6.1.schema.json) — machine-readable JSON Schema (draft 2020-12), current version. Earlier versions stay published and unchanged; see the changelog.
