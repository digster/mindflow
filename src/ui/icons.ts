...
export const ICONS = {
  ...
  // A painter's palette: the thumb-hole notch is what distinguishes it from the
  // generic blob at 18px.
  palette: 'M12 3a9 9 0 000 18c1 0 1.7-.8 1.7-1.7 0-.5-.2-.9-.5-1.2-.3-.3-.5-.7-.5-1.1 0-.9.8-1.7 1.7-1.7H16a5 5 0 005-5c0-4-4-7.3-9-7.3z M7.5 9.5v.01 M11 7v.01 M15 8.5v.01 M17.5 12v.01',
